...
class CosepW //ImprimirBLL
{
    public function GetFacturaCosepW($Cliente, $CodigoUbicacion, $Lectura_Actual, $Lectura_Anterior, $Consumo, $Cobro, $GeneracionFactura, $DataBaseAlias, $EmpresaNombre){
        ...
        for ($i=0; $i <= 11; $i++) {
            if($NFactura == 0){
                ...
                $Historial = $Historial . '<td align="right" style="padding-top: 0; padding-bottom: 0;  padding-left: 0; padding-right: 10px;">'.$laFacturaCliente[0]->MontoTotal.'</td>';
                $Historial = $Historial . '<td align="left" style="padding-top: 0; padding-bottom: 0;  padding-left: 35px; padding-right: 0;">'.($laFacturaCliente[0]->Estado == 1 ? "Impaga" : "Pagado").'</td>';
                ...
                if(isset($laHistorial[$Indice]->M3)){
                    ...
                    $Historial = $Historial . '<td align="right" style="padding-top: 0; padding-bottom: 0;  padding-left: 0; padding-right: 10px;">'.$laHistorial[$Indice]->MontoFactura.'</td>';
                    $Historial = $Historial . '<td align="left" style="padding-top: 0; padding-bottom: 0;  padding-left: 35px; padding-right: 0;">'.$laHistorial[$Indice]->Estado.'</td>';
            ...
            <table style="width: 100%; font-size: 16px;" cellpadding="-5" cellspacing="-5">
                <thead>
                    <tr>
                        ...
                        <th width="5%"> </th>
                        <th width="14%"> </th>
                        <th colspan="2" width="15%" style="font-size: 30px; padding-right: 35px;" height="50px" align="right">'. $Cliente .'</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        <td height="85px" colspan="6" align="left" style="font-size: 30px; padding: 0;">'. $laCliente[0]->Nombre .'</td>
                        <td colspan="2" align="left" style="padding-top: 0; padding-bottom: 0;  padding-left: 30px; padding-right: 0;">'. $laCliente[0]->NombreCategoria .'</td>
                    ...
                    <tr>
                        ...
                        <td colspan="2" align="left" style="padding-top: 0; padding-bottom: 0;  padding-left: 55px; padding-right: 0;">'. $newDate .'</td>
