...
class ImprimirBLLPrueba
{
    public function GetFactura($Cliente, $CodigoUbicacion, $Lectura_Actual, $Lectura_Anterior, $Consumo, $Cobro, $GeneracionFactura, $DataBaseAlias){
        ...
        // <span style="float:right">'.$laFacturaDetalle[$i]->MontoPago.'</span>
        ...
        $Indice         = 0;
        // count($laHistorial)
        // <span style="float:right;">'.(round($laFacturaCliente[0]->Consumo, 0)).'</span>
        // <span style="float:right;">'.(round($laHistorial[$Indice]->M3, 0)).'</span>
        for ($i=0; $i <= 11; $i++) {
        // for ($i=0; $i <= count($laHistorial); $i++) {
            if($NFactura == 0){
                ...
                // $Historial = $Historial . '<td align="right" style="padding: 0;">'.(round($laFacturaCliente[0]->Consumo, 0)).'</td>';
                ...
                $Historial = $Historial . '<td align="left" style="padding-top: 0; padding-bottom: 0;  padding-left: 55px; padding-right: 0;">'.($laFacturaCliente[0]->Estado == 1 ? "Impaga" : "Pagado").'</td>'; // padding-top: 0; padding-bottom: 0;  padding-left: 10px; padding-right: 0;
                ...
                if(isset($laHistorial[$Indice]->M3)){
                    ...
                    // $Historial = $Historial . '<td align="right" style="padding: 0;">'.(round($laHistorial[$Indice]->M3, 0)).'</td>';
                    $Historial = $Historial . '<td align="right" style="padding-top: 0; padding-bottom: 0;  padding-left: 0; padding-right: 0;">'.$laHistorial[$Indice]->MontoFactura.'</td>'; // padding-top: 0; padding-bottom: 0;  padding-left: 20px; padding-right: 0;
                    $Historial = $Historial . '<td align="left" style="padding-top: 0; padding-bottom: 0;  padding-left: 55px; padding-right: 0;">'.$laHistorial[$Indice]->Estado.'</td>'; // padding-top: 0; padding-bottom: 0;  padding-left: 10px; padding-right: 0;
        ...
        $DeudaAtrasada = $TotalDeuda; // - $laHistorial[0]->MontoFactura; // $laFacturaCliente[0]->Monto
        ...
        // margin: -20pt -20pt -20pt 35pt; original
        ...
        //     }
        // </style>
        // <th rowspan="22"> <p style="writing-mode: vertical-lr; transform: rotate(-90deg);" width="100%">'.$Lecturador.'</p> </th>
